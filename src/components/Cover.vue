...
<template>
    <Transition>
        <div class="cover-container" v-show="isShowCover">
            <div class="icon-nba-logo-mark">
                <IconNBALogoMark />
            </div>

            <div class="icon-nba-logo">
                <IconNBALogo />
            </div>

            <button class="btn btn-explore" @click="expolre">
                <p>探索地圖</p>
            </button>
...
.v-enter-active,
.v-leave-active {
    transition: opacity 0.6s 0.28s ease;
}
